...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 0 }, { marker: 'pandoc', elapsed: 120 }, { marker: 'post-processor', elapsed: 30 }, { marker: 'pre-processor', elapsed: 50 }, { marker: 'render', elapsed: 900 } ];
