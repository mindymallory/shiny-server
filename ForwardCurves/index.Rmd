...
output$cornplot <- renderggiraph({
    ggiraph(code = print(c), pointsize = 12, flexdashboard = TRUE)
  })
...
ggiraphOutput("cornplot")
output$cornplot <- renderggiraph({
    ggiraph(code = print(c), pointsize = 12)
  })
...
output$soybeanplot <- renderggiraph({
    ggiraph(code = print(s), s, pointsize = 10, flexdashboard = TRUE)
  })
...
output$soybeanplot <- renderggiraph({
    ggiraph(code = print(s), s, pointsize = 10)
  })
...
output$wheatplot <-    renderggiraph({
    ggiraph(code = print(w), pointsize = 10, flexdashboard = TRUE)
  })
...
output$wheatplot <-    renderggiraph({
    ggiraph(code = print(w), pointsize = 10)
  })
